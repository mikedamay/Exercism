...
namespace ExerciseReport
{
    internal class DesignDocParser
    {
        ...
        public IEnumerable<(Result result, string error, string concept, string objective)> ParseDesignDoc(
            ...
            LineToConceptAndObjective(string docId, string line)
        {
            ...
            {
                var results = new List<(Result result, string error, string concept, string objective)>();
                ...
                {
                    results.Add((Result.Success, string.Empty, conceptName.Trim(), learningObjective.Trim()));
                }
            ...
            {
                return new List<(Result result, string error, string concept, string objective)>{(Result.Errors, $"{docId}: invalid format: {line}", string.Empty, string.Empty)};
            }
        }
